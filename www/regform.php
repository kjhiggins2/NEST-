...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form>\
      ...
      <label>zip code</label> <input type="text" id="zip" required><br>
      <label for="school">School</label>
      <select id="school">
        <option value="Tollgate">Tollgate</option>
        <option value="Pilgrim">Pilgrim</option>
        <option value="Moses Brown">Moses Brown</option>
        <option value="Mount St Charles"> Mount St Charles</option>
